<%-- 
    Document   : Mechanic-Book
    Created on : Sep 14, 2021, 12:42:36 PM
    Author     : GSSB
--%>
        ...
        <div class="contain">
            <div class="book">
                ...
                <div class="description">
                    <h1>Book your Computer Repair Service</h1>
                ...
                <div class="form">
                    <form action="GetValues" method="post">
                        <div class="inpbox">
                            ...
                            <input value="Computer Repair"  name="service" readonly>
                        </div>
                        ...
                        <div class="inpbox full" >
                            <div class="inrbox">
                                <i class="bx bx-laptop bx-md">One-Time</i>
                            <input type="radio" name="price" value="300" id="priceOne">
                            <label for="priceMe">R300</label><br>
                            <i class="bx bx-laptop bx-md">Regular</i>
                            <input type="radio" name="price" value="250" id="priceRe">
                            <label for="priceMe">R250</label>
                            </div>
                        </div> 
